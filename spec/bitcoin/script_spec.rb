...
RSpec.describe Bitcoin::Script do
  ...
  describe "#evaluate" do
    it "returns true on valid op_checksig" do
      ...
      sec = Helpers::Encoding.from_bytes(
        "\x04887387e452b8eacc4acfde10d9aaf7f6d9a0f975aabb10d006e4da568744d06c61de6d95231cd89026e2\
        86df3b6ae4a894a3378e393e93a0f45b666329a0ae34"
      )
      sig = Helpers::Encoding.from_bytes(
        "\x3045022000eff69ef2b1bd93a66ed5219add4fb51e11a840f404876325a1e8ffe0529a2c02210\
